 ...
 */
class GameStartScene extends BaseScene_1.default {
    constructor() {
    ...
    create(data) {
        ...
        this.add.bitmapText(this.cameras.main.centerX, titleBitmapText.y + titleBitmapText.height + spacingBetweenTitleAndHelperText, FontAsset_1.FontAsset.PressStart2P, helperText, helperTextFontSize).setOrigin(0.5, 0);
    }
    /**
...
GameStartScene.KEY = "GameStartScene";
